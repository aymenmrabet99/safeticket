...
class LoginScreen extends StatelessWidget {
  ...
  Widget _buildMobileNumberInput(BuildContext context) {
    return Padding(
      ...
      child: CustomTextFormField(
        ...
        hintStyle: CustomTextStyles.bodyMediumArimoOnPrimary,
        contentPadding: EdgeInsets.symmetric(horizontal: 16.h, vertical: 12.h),
  ...
  Widget _buildPasswordInput(BuildContext context) {
    return CustomTextFormField(
      ...
      hintText: "••••••••••••",
      hintStyle: CustomTextStyles.bodyLargeArimoOnPrimary,
  ...
  Widget _buildForgotPasswordButton(BuildContext context) {
    return CustomElevatedButton(
      ...
      buttonTextStyle: CustomTextStyles.labelLargePoppinsOnPrimaryContainer,
    );
  }
  ...
  Widget _buildGoogleSignInButton(BuildContext context) {
    return CustomElevatedButton(
      ...
      buttonTextStyle: CustomTextStyles.bodyMediumPoppinsOnPrimary,
    );
  }
}
